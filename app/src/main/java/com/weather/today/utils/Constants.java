package com.weather.today.utils;
...
public class Constants {
    ...
    public static final String ACTION_FORCED_APPWIDGET_UPDATE =
            "com.weather.today.action.FORCED_APPWIDGET_UPDATE";
    public static final String ACTION_APPWIDGET_THEME_CHANGED =
            "com.weather.today.action.APPWIDGET_THEME_CHANGED";
    public static final String ACTION_APPWIDGET_UPDATE_PERIOD_CHANGED =
            "com.weather.today.action.APPWIDGET_UPDATE_PERIOD_CHANGED";

    /**
     * URIs constants
     */
    public static final String SOURCE_CODE_URI = "https://github.com/qqq3/good-com.weather";
    ...
    public static final String WEATHER_ENDPOINT = "http://api.openweathermap.org/data/2.5/com.weather";
